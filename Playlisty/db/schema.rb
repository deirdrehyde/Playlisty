...
ActiveRecord::Schema.define(version: 20170831171423) do
  ...
  create_table "follows", force: :cascade do |t|
    ...
    t.index ["playlist_id", "follower_id"], name: "index_follows_on_playlist_id_and_follower_id", unique: true, using: :btree
    t.index ["playlist_id"], name: "index_follows_on_playlist_id", using: :btree
  end
